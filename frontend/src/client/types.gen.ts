...
export type AIFlashcardsRequest = {
  prompt: string
}
...
export type FlashcardsCreateAiCollectionData = {
  requestBody: AIFlashcardsRequest
}

export type FlashcardsCreateAiCollectionResponse = Collection
